...
def gen_resume(request):
    if request.method=='POST':
        ...
        return render(request,'resume.html',{
                                            'name':name,'about':about,'skill5':skill5,'age':age,'email':email,'phone':phone,'skill1':skill1,'skill2':skill2,'skill3':skill3,'skill4':skill4,
                                            'degree1':degree1,'degree2':degree2,'degree3':degree3,'college1':college1,'college2':college2,'college3':college3,'year1':year1,'year2':year2,'year3':year3,'lang1':lang1,'lang2':lang2,'lang3':lang3,'project1':project1,'project2':project2,'durat1':durat1,'desc1':desc1,'desc2':desc2,'durat2':durat2,'company1':company1,'post1':post1,'post2':post2,'company2':company2,'duration1':duration1,'duration2':duration2,'lin11':lin11,'lin21':lin21,'ach1':ach1,'ach2':ach2,'ach3':ach3})
    return render(request,'index.html')
